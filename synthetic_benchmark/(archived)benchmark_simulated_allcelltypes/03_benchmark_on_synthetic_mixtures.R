...
code_dir <- here('code', 'synthetic_benchmark_new', 'benchmark_simulated_allcelltypes')
read_dir <- here('data', 'interim', 'synthetic_benchmark_new', 'benchmark_simulated_allcelltypes', '02_extract_parameter_posterior')

write_dir <- here('data', 'interim', 'synthetic_benchmark_new', 'benchmark_simulated_allcelltypes', '03_benchmark_on_synthetic_mixtures')
