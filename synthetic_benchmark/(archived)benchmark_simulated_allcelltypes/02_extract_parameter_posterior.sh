...
#SBATCH --mem=72G
#SBATCH --job-name=01
#SBATCH -e error_and_output/02_extract_parameter_posterior.err
#SBATCH -o error_and_output/02_extract_parameter_posterior.out 
...
Rscript code/synthetic_benchmark_new/benchmark_simulated_allcelltypes/02_extract_parameter_posterior.R 