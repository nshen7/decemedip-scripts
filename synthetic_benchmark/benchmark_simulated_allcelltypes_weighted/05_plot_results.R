...
# ---- set file paths ----
read_dir <- here('data', 'interim', 'synthetic_benchmark_new', 'benchmark_simulated_allcelltypes_weighted', '04_summarize_results')
plot_dir <- here('plots', 'synthetic_benchmark_new', 'benchmark_simulated_allcelltypes_weighted', '05_plot_results')
