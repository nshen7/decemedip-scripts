...
#SBATCH -e error_and_output/04_summarize_results_refv4.err
#SBATCH -o error_and_output/04_summarize_results_refv4.out 
...
Rscript code/synthetic_benchmark_new/benchmark_simulated_allcelltypes_weighted/04_summarize_results_refv4.R 
