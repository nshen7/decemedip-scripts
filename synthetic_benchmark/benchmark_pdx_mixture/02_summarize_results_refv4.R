...
# ---- set file paths ----
read_dir <- here('data', 'interim', 'synthetic_benchmark_new', 'benchmark_pdx_mixture', '01_benchmark_on_synthetic_mixtures_refv4')
write_dir <- here('data', 'interim', 'synthetic_benchmark_new', 'benchmark_pdx_mixture', '02_summarize_results_refv4')
if (!file.exists(write_dir)) dir.create(write_dir, recursive = TRUE)
plot_dir <- here('plots', 'synthetic_benchmark_new', 'benchmark_pdx_mixture', '02_summarize_results_refv4')
