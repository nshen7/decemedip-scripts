...
#SBATCH --mem=96G
#SBATCH --job-name=02
#SBATCH -e error_and_output/02_summarize_results_refv4.err
#SBATCH -o error_and_output/02_summarize_results_refv4.out 
...
Rscript code/case_studies/shen2018_new/02_summarize_results_refv4.R
