...
read_dir <-  here('data', 'interim', 'case_studies', 'berchuck2022', '01_apply_deconv_refv4')
write_dir <- here('data', 'interim', 'case_studies', 'berchuck2022', '02_summarize_results_refv4')
if (!file.exists(write_dir)) dir.create(write_dir, recursive = T)
plot_dir <- here('plots', 'case_studies', 'berchuck2022', '02_summarize_results_refv4')
