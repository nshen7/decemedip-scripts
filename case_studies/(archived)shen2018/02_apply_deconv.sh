...
#SBATCH --mem=96G
#SBATCH --job-name=02
#SBATCH -e error_and_output/02_apply_deconv.err
#SBATCH -o error_and_output/02_apply_deconv.out 
...
Rscript code/case_studies/shen2018/02_apply_deconv.R -g ${group}
